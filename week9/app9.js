...
var createTableQuery = "CREATE TABLE music (name varchar(100) , metronomeBpm smallint, monthCreated date, genre varchar(50);"
var insertIntoQuery = "INSERT INTO music VALUES ('Cheap Thrill', 90, DEFAULT, 'pop');"
var query = "SELECT * FROM music WHERE * GROUP BY * ORDER BY *;"; //sum(amount), avg(amount), comma is used to separate columns of select
